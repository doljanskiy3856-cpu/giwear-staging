...
export function getProductOverride(
  ...
  // ── КОСТЮМ-САУНА KINTAYO ─────────────────────────────────────────────────
  if (productId === '1116') return KINTAYO_SAUNA_SUIT;
...
// ─── KINTAYO КОСТЮМ-САУНА (id 1116) ─────────────────────────────────────────
const KINTAYO_SAUNA_SUIT: ProductOverride = {
  shortDesc:
    'Спортивний костюм-сауна KINTAYO — для тренувань із підвищеним потовиділенням. Виготовлений із матеріалу з водовідштовхувальним покриттям, яке утримує тепло під час фізичної активності. Підходить для розігріву та інтенсивних тренувальних сесій.',
  usage: [
    'Тренування з підвищеним потовиділенням',
    'Розігрів перед фізичними навантаженнями',
    'Інтенсивні тренувальні сесії в залі або вдома',
  ],
  whoFor:
    'Для дорослих спортсменів і тих, хто займається фітнесом, єдиноборствами або іншими видами спорту та хоче підвищити інтенсивність потовиділення під час тренування.',
  features: [
    'Матеріал з водовідштовхувальним і силіконовим покриттям — утримує тепло всередині',
    'Матеріал, що запобігає розриву — підходить для активних тренувань',
    'Кофта з капюшоном на шнурках',
    'Резинка на манжетах (4,5 см) із застібками-липучками на зап\'ясті',
    'Повністю посилений еластичний пояс кофти (4,5 см)',
    'Велика кишеня для цінних речей',
    'Штани з повним еластичним поясом (4 см) і шнурком',
    'Вільна посадка для зручності рухів під час тренування',
  ],
  specs: {
    'Бренд': 'KINTAYO',
    'Колір': 'Чорний',
    'Комплект': 'Кофта з капюшоном + штани',
    'Розмірна сітка': 'S, M, L, XL',
    'Гарантія': '3 місяці з моменту купівлі',
  },
  kit: [],
  kitFixed: true,
  audience: '',
