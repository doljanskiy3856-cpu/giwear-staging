...
const COLOR_HEX: Record<string, string> = { Білий:"#FFFFFF", Біле:"#FFFFFF", Біла:"#FFFFFF", Синій:"#1B4FBF", Синє:"#1B4FBF", Синя:"#1B4FBF", Чорний:"#1A1A1A", Чорне:"#1A1A1A", Червоний:"#E8232A", Червоне:"#E8232A", Жовтий:"#F5C518", Жовте:"#F5C518", Зелений:"#2D7A2D", Зелене:"#2D7A2D", Коричневий:"#8B4513", Фіолетовий:"#6B2FA0", Сірий:"#808080", Помаранчевий:"#FF8C00", Помаранчеве:"#FF8C00" };
